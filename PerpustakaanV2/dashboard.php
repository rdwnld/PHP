...
<body class="g-sidenav-show   bg-gray-100">
  ...
  <aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href=" https://demos.creative-tim.com/argon-dashboard/pages/dashboard.html " target="_blank">
        ...
        <span class="ms-1 font-weight-bold">PerpustakaanV2</span>
      </a>
    </div>
      ...
      <div class="container-fluid py-1 px-3">
        ...
        <div class="collapse navbar-collapse mt-sm-0 mt-2 me-md-0" id="navbar">
          <div class="ms-md-auto pe-md-3 d-flex align-items-center">
            <span class="text-white btn btn-outline-light">Selamat Datang, <?= $_SESSION['username']; ?> </span>
            <a href="routes/proses.php?aksi=logout" class="text-white btn btn-outline-light ms-2">Logout</a>
          </div>
        </div>
            ...
            <div class="row align-items-center justify-content-lg-between">
              <div class="col-lg-6 mb-lg-0 mb-4">
                <div class="copyright text-center text-sm text-muted text-lg-start">
                  ...
                  <a href="https://www.creative-tim.com" class="font-weight-bold" target="_blank">Perpustakaanmini v.2</a>
                  for a better web.
                </div>
              </div>
              <div class="col-lg-6">
  ...
  <div class="fixed-plugin">
    ...
    <script src="assets/js/plugins/chartjs.min.js"></script>mx
